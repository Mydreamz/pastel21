  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col antialiased text-foreground relative overflow-hidden pb-16 md:pb-0">
        <StarsBackground />
        <div className="bg-grid absolute inset-0 opacity-[0.02] z-0 dark:opacity-[0.03]"></div>
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          ...
          <section id="features" className="py-16 md:py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="glass-card shadow-neumorphic backdrop-blur-xl rounded-2xl p-8 hover:shadow-elevated transition-all duration-300 dark:shadow-glass dark:hover:shadow-glow">
          ...
          <section id="pricing" className="py-16 md:py-24">
            <div className="glass-card shadow-neumorphic backdrop-blur-xl rounded-3xl p-8 md:p-12 dark:shadow-glass">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <ul className="space-y-4">
                    {["Free to get started", "No credit card required", "Cancel anytime"].map((item, i) => (
                      <li key={i} className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 dark:text-neon-blue" />
                  ...
                  <Button 
                    size="lg"
                    className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-elevated hover:shadow-lg transition-all duration-200 px-8 py-3 dark:bg-neon-blue dark:hover:bg-neon-blue/90 dark:text-background dark:shadow-glow"
                ...
                <div className="glass-card p-8 backdrop-blur-xl rounded-2xl border border-border/50 shadow-elevated dark:border-glass-border dark:shadow-glass">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-2xl font-semibold text-foreground font-display">Pro Plan</h3>
                    <div className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium dark:bg-neon-blue/10 dark:text-neon-blue">Popular</div>
                  </div>
                  ...
                  <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg dark:bg-neon-blue dark:hover:bg-neon-blue/90 dark:text-background dark:shadow-glow">
                    Get Started
                  </Button>
                </div>
              </div>
