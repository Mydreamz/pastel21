...
const Index = () => {
  ...
  // This function will be passed down from AppLayout via context or props
  // For now, we'll handle it through the existing navigation structure
  const openAuthDialog = (tab: 'login' | 'signup') => {
    // This will be handled by the AppLayout's AuthDialog through MainNav
    console.log('Auth dialog should open:', tab);
  };
