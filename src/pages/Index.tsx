        ...
        <section id="features" className="py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="glass-card shadow-neumorphic backdrop-blur-xl bg-white/50 rounded-2xl p-6 mobile-card mobile-touch-feedback">
        ...
        <section id="pricing" className="py-16 md:py-24">
          <div className="glass-card shadow-neumorphic backdrop-blur-xl bg-white/50 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="glass-card p-6 backdrop-blur-xl bg-white/60 rounded-2xl border border-emerald-200/50 mobile-card">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold text-gray-800">Pro Plan</h3>
                  <div className="px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-sm font-medium">Popular</div>
                </div>
                ...
                <Button className="w-full bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl touch-target mobile-touch-feedback">
                  Get Started
                </Button>
              </div>
            </div>
