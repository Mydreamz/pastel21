...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col antialiased text-foreground relative">
      <StarsBackground />
      ...
      <main className="flex-1 w-full max-w-screen-xl mx-auto px-4 md:px-6 relative z-10 pb-20 md:pb-0">
        ...
        <section id="features" className="py-16 md:py-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground font-lora">Everything creators need to monetize with Monitize.club</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-card border border-border shadow-sm rounded-lg p-6 transition-all duration-200 hover:shadow-md">
                <div className="text-3xl mb-4">{feature.icon}</div>
                <h3 className="text-xl font-bold mb-2 text-foreground font-lora">{feature.title}</h3>
        ...
        <section id="pricing" className="py-16 md:py-24">
          <div className="bg-card border border-border shadow-sm rounded-lg p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-foreground font-lora">Ready to start monetizing your content with Monitize.club?</h2>
              ...
              <div className="bg-card border border-border rounded-lg p-6 shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold text-foreground font-lora">Pro Plan</h3>
