          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField control={form.control} name="teaser" render={({
                field
              }) => <FormItem>
                ...
                <div className="space-y-4 sm:space-y-3">
                  ...
                  <Tabs defaultValue="text" value={selectedContentType} onValueChange={setSelectedContentType} className="w-full pt-13">
                    <TabsList className={`grid ${isMobile ? 'grid-cols-3 gap-1' : 'grid-cols-3 md:grid-cols-6'} bg-white/5 border border-white/10 p-1`}>
                      {contentTypes.map(type => <TabsTrigger key={type.id} value={type.id} className="data-[state=active]:bg-emerald-500 data-[state=active]:text-white flex items-center justify-center h-10 px-2 text-xs sm:text-sm">
                ...
                <div className="pt-2">
                  ...
                  {showAdvanced && <div className="mt-4 space-y-4 p-4 bg-white/5 border border-white/10 rounded-md">
                      <FormField control={form.control} name="expiry" render={({
                    field
                  }) => <FormItem>
                            <FormLabel className="flex items-center gap-2">
