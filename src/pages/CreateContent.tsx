  ...
  return <div className="min-h-screen bg-[#111111] text-white">
      <div className="max-w-[560px] mx-auto px-4 py-6">
        ...
        <div className="space-y-6">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 my-0">
              ...
              <div className="flex justify-end gap-3 pt-4">
                <Button type="button" variant="ghost" onClick={() => navigate('/')} className="text-gray-400 hover:text-white hover:bg-white/10">
                  Cancel
                </Button>
