...
const Dashboard = () => {
  ...
  return (
    <div 
      style={parallaxStyle} 
      className="glass-card p-6 rounded-2xl w-full max-w-[560px] mx-auto lg:mx-0 animate-float-slow backdrop-blur-xl border border-cream-200/60 shadow-neumorphic relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <div className="w-3 h-3 rounded-full bg-red-500 shadow-neumorphic-sm"></div>
            <div className="w-3 h-3 rounded-full bg-yellow-500 shadow-neumorphic-sm"></div>
            <div className="w-3 h-3 rounded-full bg-primary shadow-neumorphic-sm"></div>
          </div>
        </div>
