...
import { Eye, FileText, Image, Video, Link as LinkIcon, DollarSign, Clock, User } from 'lucide-react';
...
const PurchasedContent: React.FC<PurchasedContentProps> = ({ contents, loading, filters }) => {
