    ...
    <div className="p-4 border-b border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <div className="relative w-full md:w-64">
        <input 
          ...
          className="w-full bg-white/5 border border-white/10 rounded-xl py-2 pl-8 pr-4 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-pastel-500/50"
        />
