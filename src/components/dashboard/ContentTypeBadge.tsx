...
const ContentTypeBadge: React.FC<ContentTypeBadgeProps> = ({ contentType }) => {
  switch (contentType) {
    ...
    case 'image':
      return (
        <Badge variant="outline" className="bg-emerald-400/20 text-emerald-700 border-emerald-400/30 rounded-full">
    ...
    case 'link':
      return (
        <Badge variant="outline" className="bg-emerald-200/20 text-emerald-700 border-emerald-200/30 rounded-full">
          <LinkIcon className="h-3 w-3 mr-1" /> Link
        </Badge>
      );
    default:
      return (
        <Badge variant="outline" className="bg-emerald-100/20 text-emerald-700 border-emerald-100/30 rounded-full">
