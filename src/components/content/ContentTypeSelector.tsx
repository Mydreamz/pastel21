...
const ContentTypeSelector = ({
  ...
  return <div className="space-y-6 sm:space-y-6 w-full">
      ...
      <Tabs defaultValue="text" value={selectedContentType} onValueChange={setSelectedContentType} className="w-full">
        ...
        <div className="mt-2 sm:mt-2 space-y-2 top-16">
          ...
          {['image', 'video', 'audio', 'document'].map(type => <TabsContent key={type} value={type} className="p-4 bg-white/5 border border-white/10 rounded-md">
